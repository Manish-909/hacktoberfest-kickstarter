#!/usr/bin/env python3
"""
Enhanced Resume Processor using Gemini API
...
try:
    ...
    PDF_SUPPORT = False
    print("Warning: PDF/DOCX support not available. Please install: pip install PyPDF2 pdfplumber python-docx")

class EnhancedResumeProcessor:
    """Enhanced service for processing resume files and extracting profile information using Gemini AI"""
    ...
    def extract_text_from_pdf(self, file_path: str) -> str:
        ...
        if not PDF_SUPPORT:
            raise Exception("PDF support not available. Please install required libraries.")
    ...
    def extract_text_from_docx(self, file_path: str) -> str:
        ...
        if not PDF_SUPPORT:
            raise Exception("DOCX support not available. Please install required libraries.")
    ...
    def extract_text_from_file(self, file_path: str) -> str:
        ...
        if extension == '.pdf':
            ...
            raise Exception(f"Unsupported file type: {extension}. Supported types: .pdf, .docx, .doc, .txt")
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python enhanced_resume_processor.py <resume_file_path>")
